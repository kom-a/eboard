        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav me-auto mb-2 mb-md-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="index.php?page=c">Аккаунт</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="index.php?page=c">Друзья</a>
                    </li>
                </ul>
                ...
                if (!isset($_SESSION['email']) || $_SESSION['email'] == '')
                {
                    ...
                    echo '<input class="form-control me-2" type="email" placeholder="Логин" name="email" aria-label="Почта"/>';
